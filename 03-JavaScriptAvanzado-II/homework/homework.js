...
const cacheFunction = (cb) => {
  let cache = {}
  return value =>
    cache.hasOwnProperty(value) ? cache[value] : (cache[value] = cb(value))
}
...
const crearCadena = (delimitadorIzquierda, delimitadorDerecha, cadena) => 
  delimitadorIzquierda + cadena + delimitadorDerecha
